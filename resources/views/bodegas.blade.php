...
@section('nav')
    <x-nav :type="'tiendas'" :menu="'bodegas'"></x-nav>
@endsection
...
@section('slider')
    ...
    <section class="p-0">
        <img src="assets/img/banner/banner_bodega.jpg" class="mx-auto d-block img-fluid">
    </section>
@endsection
        ...
        <div class="row">
            <div class="col-12">
                <div class="section-tittle text-center mb-5">                            
                    ...
                    <div class="d-inline-block bg-yellow-400" style="width: 125px; height: 7px;"></div>
                </div>
        ...
        <div class="row justify-content-md-center">
            <div class="wow-pricing-table col col-md-3">
                <div class="wow-pricing unitienda">
                    <div class="wow-pricing-header bg-yellow-400">
                        <h5>Pinar del Rio</h5>
                    </div>
                    <div class="wow-pricing-content">
                        <br>
                        <img class="img-fluid" src="assets/img/bulevar/bodega.png" alt=""/>

                    </div>
                    <div class="wow-pricing-button">
                        <a href="#" class="btn btn-danger bg-yellow-400" target="_self" rel="nofollow">Entrar</a>
                    </div>
                </div>
            </div>
            <div class="wow-pricing-table col col-md-3">
                <div class="wow-pricing unitienda-featured">
                    <div class="wow-pricing-header bg-red-700">
                        <h5>Artemisa</h5>
                    </div>
                    <div class="wow-pricing-content">
                        <br>
                    ...
                    <div class="wow-pricing-button">
                        <a href="#" class="btn btn-danger bg-red-700" target="_self" rel="nofollow">Entrar</a>
                    </div>
                </div>
            </div>
            <div class="wow-pricing-table col col-md-3">
            ...
            <div class="wow-pricing-table col col-md-3">
                <div class="wow-pricing unitienda-featured">
                    ...
                    <div class="wow-pricing-button">
                        <a href="https://gtm.unitiendas.cinet.cu" class="btn btn-danger bg-yellow-400" target="_self" rel="nofollow">Entrar</a>
                    </div>
                </div>
            </div>
