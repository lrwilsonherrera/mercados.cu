    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right" style="padding: 10px">
                ...
                <li class="active"><a class="page-scroll" href="{{ route('mercabal') }}">Mercabal</a></li>
...
<section>
    <div style="padding: 50px 0px 0px">
        <img class="img-fluid" src="{{ asset('assets/img/banner/banner_mercabal.jpg') }}" alt=""/>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="wow-pricing-table col-md-3">
                <div class="wow-pricing mercabal-featured">
                    <div class="wow-pricing-header">
                        <h5>Pinar del Rio</h5>
                    </div>
                    <div class="wow-pricing-content">
                        <br>
                        <img src="{{ asset('assets/img/mercabal/mercabal.jpg') }}" alt=""/>
            ...
            <!-- /.col-md-4 -->
            <div class="wow-pricing-table col-md-3">
                <div class="wow-pricing mercabal">
                    <div class="wow-pricing-header">
                        <h5>Artemisa</h5>
                    </div>
                    <div class="wow-pricing-content">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h1 class="bottombrand wow flipInX" href="#page-top"><img src="{{ asset('assets/img/logomercados2.png') }}" alt="logo" style="width: 100px; height: none; padding: 0px"></h1>
                <p>
